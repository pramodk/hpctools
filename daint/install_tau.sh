...
export scorep_dir=/users/kumbhar/workarena/systems/daint/softwares/install/profilers/scorep-1.4.2/cray
export cuda_dir=/opt/nvidia/cudatoolkit6.5/6.5.14-1.0502.9613.6.1
...
do
    ...
    do
        ...
        case "$package" in
            ...
            pdtoolkit-3.20)
                ./configure -prefix=$pdt_install_dir 
                make install
                ;;
